class Item < ApplicationRecord
  ...
  validates :category_id, :state_id, :fee_id, :days_id, numericality: { other_than: 1, message: 'カテゴリを選択してください' }
  validates :province_id, numericality: { other_than: 0, message: '都道府県を選択してください'}
