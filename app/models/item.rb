class Item < ApplicationRecord
  ...
  validates :name, :detail, :category_id, :state_id, :fee_id, :province_id, :days_id, :user_id, :price, presence: true
  ...
  validates :price, numericality:{less_than_or_equal_to: 9999999, message:'300円以上9,999,999円以下で入力してください'}
end
